...
const slides = [
  ...
  },
  {
    slideClass: 'slide-1',
    tag: 'Kategori Unggulan',
    titleAccent: 'Suspension',
    titleLine2: '',
    desc: 'Sistem suspensi performa tinggi. Shock absorber, fork, dan pegas dengan teknologi damping terkini untuk kenyamanan maksimal.',
    ghostLabel: 'Lihat Produk',
    stats: [{ num: '200+', label: 'Produk Tersedia' }, { num: 'OEM', label: 'Certified Quality' }, { num: '1 Yr', label: 'Garansi Resmi' }],
    badges: ['Premium Grade', 'Comfort Ride', 'Top Rated'],
    video: '/hero-suspension-video.mp4',
  },
  {
    slideClass: 'slide-2',
    tag: 'Kategori Unggulan',
    titleAccent: 'Brakes',
    titleLine2: '',
    desc: 'Sistem pengereman handal dan responsif. Disc brake, kampas rem, dan caliper dengan material tahan panas untuk keamanan berkendara.',
    ghostLabel: 'Lihat Produk',
    stats: [{ num: '300+', label: 'Produk Tersedia' }, { num: 'OEM', label: 'Certified Quality' }, { num: '2 Yr', label: 'Garansi Resmi' }],
    badges: ['Safety First', 'Best Seller', 'Track Tested'],
    video: '/hero-brakes-video.mp4',
  },
];
